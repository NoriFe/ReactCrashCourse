...
const EditCoursePage = ({updateCourseSubmit}) => {
  ...
  const [topic, setTopic] = useState(courses.topic);
  const [type, setType] = useState(courses.type);
  const [location, setLocation] = useState(courses.location);
  const [description, setDescription] = useState(courses.description);
  const [price, setPrice] = useState(courses.price);
  const [companyName, setCompanyName] = useState(courses.provider.name);
  const [companyDescription, setCompanyDescription] = useState(courses.provider.description);
  const [contactEmail, setContactEmail] = useState(courses.provider.contactEmail);
  const [contactPhone, setContactPhone] = useState(courses.provider.contactPhone);
